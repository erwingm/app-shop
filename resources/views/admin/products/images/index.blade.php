@extends('layouts.app')
@section('title', 'Images de Productos')
        ...
        <div class="main main-raised">
            <div class="container">
                <div class="section text-center">
                    <h2 class="title">Images del Producto "{{$product->name}}"</h2>
w
                        <form method="post" action="" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <input type="file" name="photo" required>
                            <button type="submit" class="btn btn-primary btn-round ">Subir Nueva Imagen</button>
                            <a href="{{url('/admin/products')}}" class="btn btn-default btn-round ">Volver Listado de Productos</a>
                        </form>
<hr>
                        ...
                        <div class="col-md-4">
                            <div class="panel panel-default">
                                <div class="panel-body">
                                   <!--  campo calculado url de ProductImage -->
